...
| 4 | Stage-1 gist PILOT — **DONE 2026-07-10, PASS** | 7B QLoRA, k=8 gist slots, 16000 steps (~16M tokens), 3090 | ~$1.5 (+infra debugging) | **gap_closed=0.887 at step 16000** (bar 0.5), stable 0.87-0.89 across the back half. PPL gist=12.91 vs full=12.40 vs none=16.96 — 8 gist tokens ≈ full sentence. Weights (adapter+gist) in mattyvee/mimir-artifacts step-0016000. ⇒ SCALE: build Stage 2 (next-thought predictor). |
